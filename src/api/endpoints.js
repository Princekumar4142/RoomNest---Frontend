...
export const adminApi = {
  ...
  allOwners: () => client.get("/admin/owners"),
  verifyOwner: (id, approve) => client.patch(`/admin/owners/${id}/verify`, { approve }),
  allUsers: () => client.get("/admin/users"),
  suspendUser: (id, suspend) => client.patch(`/admin/users/${id}/suspend`, { suspend }),
  banUser: (id, ban) => client.patch(`/admin/users/${id}/ban`, { ban }),
  deleteAccount: (id) => client.delete(`/admin/users/${id}`),
};
